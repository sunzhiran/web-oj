...
<div class="template-page-wrapper">
    ...
    <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form role="form" id="templatemo-preferences-form" onsubmit="return checkUserAdd();" method="post" action="<%=basePath %>addUser">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12 margin-bottom-15">
                                <label class="radio-inline">
                                    <input type="radio" name="userSex" id="userRadio1" value="男" checked> 男
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="userSex" id="userRadio2" value="女"> 女
                                </label>
                            </div>
                        </div>
                        <div class="row">
