...
<div class="template-page-wrapper">
    ...
    <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
            <h1>修改教师信息</h1>
            <%
                Teacher teacherEdited = (Teacher) request.getAttribute("teacher");
                boolean isWomen = "女".equals(teacherEdited.getTeacherSex());
            %>
            <div class="row">
                <div class="col-md-12">
                    <form role="form" id="templatemo-preferences-form" onsubmit="return checkTeacherEdit();" method="post" action="<%=basePath %>updateTeacher">
                        <div class="row">
                            <div class="col-md-6 margin-bottom-15">
                                <label for="userId" class="control-label">工号</label>
                                <input type="text" class="form-control" id="userId" name="userId" readonly="readonly" value="<%=teacherEdited.getTeacherId()%>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 margin-bottom-15">
                                <label for="username" class="control-label">姓名</label>
                                <input type="text" class="form-control" id="username" name="username" value="<%=teacherEdited.getTeacherName()%>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 margin-bottom-15">
                                <label for="password" class="control-label">密码</label>
                                <input type="text" class="form-control" id="password" name="password" value="<%=teacherEdited.getTeacherPassword()%>">
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6 margin-bottom-15">
                                ...
                                <input type="text" class="form-control" id="userNote" name="userNote" value="<%=teacherEdited.getTeacherNote()%>">
                            </div>
                        </div>
