...
<div class="template-page-wrapper">
    <div class="navbar-collapse collapse templatemo-sidebar">
        <ul class="templatemo-sidebar-menu">
            ...
            <li class="active"><a href="/web-oj/jsp/teacher/setup.jsp"><i class="fa fa-cog"></i>设置</a></li>
    ...
    <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
            <h1>修改个人信息</h1>
            <%
                boolean isWomen = "女".equals(user.getTeacherSex());
                //boolean isStudent = (1==user.getUserType());
            %>
            <div class="row">
                <div class="col-md-12">
                    <form role="form" id="templatemo-preferences-form" onsubmit="return checkTeacherSetup();" method="post" action="<%=basePath %>setupTeacher">
                        <div class="row">
                            <div class="col-md-6 margin-bottom-15">
                                <label for="userId" class="control-label">工号</label>
                                <input type="text" class="form-control" id="userId" name="userId" readonly="readonly" value="<%=user.getTeacherId()%>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 margin-bottom-15">
                                <label for="username" class="control-label">姓名</label>
                                <input type="text" class="form-control" id="username" name="username" value="<%=user.getTeacherName()%>">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 margin-bottom-15">
                                <label for="password" class="control-label">密码</label>
                                <input type="text" class="form-control" id="password" name="password" value="<%=user.getTeacherPassword()%>">
                            </div>
                        </div>
                        <div class="row">
