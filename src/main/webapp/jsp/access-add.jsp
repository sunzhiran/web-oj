...
<div class="template-page-wrapper">
    ...
    <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form role="form" id="templatemo-preferences-form" onsubmit="return checkUserAdd();" method="post" action="<%=basePath %>addAccess">
                        <div class="row">
                            <div class="col-md-6 margin-bottom-15">
                                <label for="accessname" class="control-label">权限标题</label>
                                <input type="text" class="form-control" id="accessname" name="accessname" >
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 margin-bottom-15">
                                <label for="accessurl" class="control-label">权限链接</label>
                                <input type="text" class="form-control" id="accessurl" name="accessurl" >
                            </div>
                        </div>
